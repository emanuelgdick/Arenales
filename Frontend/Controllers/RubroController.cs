...
namespace FrontEnd.Controllers
{
    public class RubroController : Controller
    {
        ...
        {
            _rubroService = new RubroService();
            _config = config;
        }
        ...
        public async Task<IActionResult> Index()
        {
         ...
         //   totales = await _rubroService.GetTotales(int.Parse(userId), HttpContext.Session.GetString("APIToken"));
            return View(totales);
        ...
        public async Task<JsonResult> CreateRubro([FromBody] Rubro Rubro)
        {
            ...
            try
            {
                if (Rubro.Id == 0)
                {
                    ...
                    {
                        Rubro = await _rubroService.AddRubro(Rubro, HttpContext.Session.GetString("APIToken"));
                        resultado = Rubro.Id;
                ...
                else
                {
                    if (Rubro.Descripcion != "")
                    {
                        await _rubroService.UpdateRubro(Rubro.Id, Rubro, HttpContext.Session.GetString("APIToken"));
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            Rubro = await _rubroService.GetRubroById(id, HttpContext.Session.GetString("APIToken"));
            return View(Rubro);
        }
        ...
        public async Task<JsonResult> DeleteRubro([FromBody] Rubro Rubro)
        {
            ...
            try
            {
                await _rubroService.DeleteRubro(Rubro.Id, HttpContext.Session.GetString("APIToken"));
                resultado = true;

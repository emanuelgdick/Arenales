...
namespace FrontEnd.Services
{
    public class ApiUserService
    {
        ...
        {
            HttpResponseMessage response = await _httpClient.PostAsJsonAsync<LoginRequestDTO>($"api/Usuarios/UserLogin", userDetails);
        ...
        {
            HttpResponseMessage response = await _httpClient.PostAsJsonAsync<LoginRequestDTO>($"api/Usuarios/AddUser", usuario);
            response.EnsureSuccessStatusCode();
            var contents = await response.Content.ReadAsStringAsync();

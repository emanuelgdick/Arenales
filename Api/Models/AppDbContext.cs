...
namespace Api
{
    public class AppDbContext : DbContext
    {
        ...
        /*
         Scaffold-DbContext "Data Source=MATIASPISCICELL;Initial Catalog=DB_A17140_BenitoJuarez;Persist Security Info=True;User ID=sa;Password=.;Encrypt=True;Trust Server Certificate=True" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -Force
         */
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Carrito>(entity =>
            {
                ...
                entity.HasOne(d => d.IdComprobanteNavigation).WithMany(p => p.Carritos)
                    .HasForeignKey(d => d.IdComprobante)
                    .HasConstraintName("FK_Carrito_Comprobante");

                entity.HasOne(d => d.IdEstadoCarritoNavigation).WithMany(p => p.Carritos)
                    .HasForeignKey(d => d.IdEstadoCarrito)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__ClienteC__3214EC07613E6B20");
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__ClienteC__3214EC07ADAAEA3C");
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__Condicio__3214EC079E0B9F5A");
            ...
            modelBuilder.Entity<Credito>(entity =>
            {
                ...
                entity.HasOne(d => d.IdEstadoCreditoNavigation).WithMany(p => p.Creditos)
                    .HasForeignKey(d => d.IdEstadoCredito)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<EstadoCarrito>(entity =>
            {
                entity.ToTable("EstadoCarrito");
            ...
            modelBuilder.Entity<ProductoImagen>(entity =>
            {
                ...
                entity.Property(e => e.LinkImagen).IsUnicode(false);
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__Proveedo__3214EC073948E8D8");
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__Proveedo__3214EC07F4CC4698");
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__TipoComp__3214EC07790560BE");
        ...
        public DbSet<Api.Models.Carrito> Carrito { get; set; } = default!;
        public DbSet<Api.Models.CarritoProducto> CarritoProducto { get; set; } = default!;
        public DbSet<Api.Models.EstadoCarrito> EstadoCarrito { get; set; } = default!;

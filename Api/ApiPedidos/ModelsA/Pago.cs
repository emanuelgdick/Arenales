...
namespace ApiPedidos.Models
{
    public partial class Pago
    {
        ...
        public int? IdProveedorCuentaCorrienteMovimiento { get; set; }

        public virtual Caja? IdCajaNavigation { get; set; }
        public virtual ClienteCuentaCorrienteMovimiento? IdClienteCuentaCorrienteMovimientoNavigation { get; set; }
